...
responses_raw_dat <- as_tibble(read_csv(paste(assets_pubs,"respondents_survey_answers.csv",sep='/'),
...
# 1) Define the new data frame, `pub_dat`, as a subset of the `responses` dataset 
